...
export function Sidebar() {
  ...
  const [navOrder, setNavOrder] = useState(['dashboard', 'finance', 'items', 'logs'])
  ...
  const userNavLinks: NavLink[] = [
    ...
    { id: 'logs', href: '/logs', label: 'Logs', icon: <ClipboardList className="h-5 w-5" />, active: pathname.startsWith('/logs') },
  ]
