        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <div className="md:col-span-3 space-y-2">
            ...
            {linesWithItems.map((entry) => (
              <div key={entry.item.id} className="grid gap-2 rounded-xl border border-white/10 bg-white/[0.03] p-2.5 md:grid-cols-[1fr_auto_auto] md:items-center">
                ...
                <div className="flex items-center justify-end gap-2">
                  {hideUnitPrice ? (
                    ...
                    <div className="flex items-center gap-1.5">
                      <span className="inline-flex h-6 items-center rounded-full border border-white/15 bg-white/[0.05] px-2 text-[10px] text-white/75">Prix</span>
                      <Input
