...
export default function NouveauEquipementPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        ...
        subtitle="Nom • prix • image • description"
        actions={
          <Link
            href="/equipement"
        ...
        <form className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="Ex: Kit cambriolage"
            />
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-sm text-white/60">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-4 text-xs text-white/60">
              ...
              <li>PNG/JPEG/WebP supportés.</li>
              <li>L’image sera upload dans Supabase Storage.</li>
            </ul>
          </div>
