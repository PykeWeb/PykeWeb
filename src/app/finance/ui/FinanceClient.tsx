  ...
  return (
    <Panel>
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
        <button type="button" data-bubble-key="finance.top.all" onClick={() => setType('all')} style={{ background: bubble('finance.top.all')?.bgColor || undefined, borderColor: bubble('finance.top.all')?.borderColor || undefined, color: bubble('finance.top.all')?.textColor || undefined, minWidth: bubble('finance.top.all')?.minWidthPx ? `${bubble('finance.top.all')?.minWidthPx}px` : undefined, minHeight: bubble('finance.top.all')?.minHeightPx ? `${bubble('finance.top.all')?.minHeightPx}px` : undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'all' ? 'border-slate-200/70 from-slate-400/35 to-slate-500/25' : 'border-white/15 from-white/10 to-white/5 hover:from-white/15 hover:to-white/8'}`}>
        ...
        <button type="button" data-bubble-key="finance.top.expense" onClick={() => setType('expense')} style={{ background: bubble('finance.top.expense')?.bgColor || undefined, borderColor: bubble('finance.top.expense')?.borderColor || undefined, color: bubble('finance.top.expense')?.textColor || undefined, minWidth: bubble('finance.top.expense')?.minWidthPx ? `${bubble('finance.top.expense')?.minWidthPx}px` : undefined, minHeight: bubble('finance.top.expense')?.minHeightPx ? `${bubble('finance.top.expense')?.minHeightPx}px` : undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'expense' ? 'border-amber-200/80 from-amber-500/35 to-orange-500/25' : 'border-amber-300/30 from-amber-500/20 to-orange-500/12 hover:from-amber-500/28 hover:to-orange-500/18'}`}>
        ...
        <button type="button" data-bubble-key="finance.top.purchase" onClick={() => setType('purchase')} style={{ background: bubble('finance.top.purchase')?.bgColor || undefined, borderColor: bubble('finance.top.purchase')?.borderColor || undefined, color: bubble('finance.top.purchase')?.textColor || undefined, minWidth: bubble('finance.top.purchase')?.minWidthPx ? `${bubble('finance.top.purchase')?.minWidthPx}px` : undefined, minHeight: bubble('finance.top.purchase')?.minHeightPx ? `${bubble('finance.top.purchase')?.minHeightPx}px` : undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'purchase' ? 'border-cyan-200/80 from-cyan-500/35 to-blue-500/25' : 'border-cyan-300/30 from-cyan-500/20 to-blue-500/12 hover:from-cyan-500/28 hover:to-blue-500/18'}`}>
        ...
        <button type="button" data-bubble-key="finance.top.stock_in" onClick={() => setType('stock_in')} style={{ background: bubble('finance.top.stock_in')?.bgColor || undefined, borderColor: bubble('finance.top.stock_in')?.borderColor || undefined, color: bubble('finance.top.stock_in')?.textColor || undefined, minWidth: bubble('finance.top.stock_in')?.minWidthPx ? `${bubble('finance.top.stock_in')?.minWidthPx}px` : undefined, minHeight: bubble('finance.top.stock_in')?.minHeightPx ? `${bubble('finance.top.stock_in')?.minHeightPx}px` : undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'stock_in' ? 'border-sky-200/80 from-sky-500/35 to-indigo-500/25' : 'border-sky-300/30 from-sky-500/20 to-indigo-500/12 hover:from-sky-500/28 hover:to-indigo-500/18'}`}>
