  ...
  return (
    <Panel>
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-6">
        <button type="button" onClick={() => setType('all')} style={{ background: bubble('finance.top.all')?.bgColor || undefined, borderColor: bubble('finance.top.all')?.borderColor || undefined, color: bubble('finance.top.all')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'all' ? 'border-slate-200/70 from-slate-400/35 to-slate-500/25' : 'border-white/15 from-white/10 to-white/5 hover:from-white/15 hover:to-white/8'}`}>
        ...
        <button type="button" onClick={() => setType('expense')} style={{ background: bubble('finance.top.expense')?.bgColor || undefined, borderColor: bubble('finance.top.expense')?.borderColor || undefined, color: bubble('finance.top.expense')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'expense' ? 'border-amber-200/80 from-amber-500/35 to-orange-500/25' : 'border-amber-300/30 from-amber-500/20 to-orange-500/12 hover:from-amber-500/28 hover:to-orange-500/18'}`}>
        ...
        <button type="button" onClick={() => setType('purchase')} style={{ background: bubble('finance.top.purchase')?.bgColor || undefined, borderColor: bubble('finance.top.purchase')?.borderColor || undefined, color: bubble('finance.top.purchase')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'purchase' ? 'border-cyan-200/80 from-cyan-500/35 to-blue-500/25' : 'border-cyan-300/30 from-cyan-500/20 to-blue-500/12 hover:from-cyan-500/28 hover:to-blue-500/18'}`}>
        ...
        <button type="button" onClick={() => setType('stock_in')} style={{ background: bubble('finance.top.stock_in')?.bgColor || undefined, borderColor: bubble('finance.top.stock_in')?.borderColor || undefined, color: bubble('finance.top.stock_in')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'stock_in' ? 'border-sky-200/80 from-sky-500/35 to-indigo-500/25' : 'border-sky-300/30 from-sky-500/20 to-indigo-500/12 hover:from-sky-500/28 hover:to-indigo-500/18'}`}>
        ...
        <button type="button" onClick={() => setType('sale')} style={{ background: bubble('finance.top.sale')?.bgColor || undefined, borderColor: bubble('finance.top.sale')?.borderColor || undefined, color: bubble('finance.top.sale')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'sale' ? 'border-violet-200/80 from-violet-500/35 to-fuchsia-500/25' : 'border-violet-300/30 from-violet-500/20 to-fuchsia-500/12 hover:from-violet-500/28 hover:to-fuchsia-500/18'}`}>
        ...
        <button type="button" onClick={() => setType('stock_out')} style={{ background: bubble('finance.top.stock_out')?.bgColor || undefined, borderColor: bubble('finance.top.stock_out')?.borderColor || undefined, color: bubble('finance.top.stock_out')?.textColor || undefined }} className={`rounded-2xl border bg-gradient-to-br p-4 text-left transition ${type === 'stock_out' ? 'border-rose-200/80 from-rose-500/35 to-orange-500/25' : 'border-rose-300/30 from-rose-500/20 to-orange-500/12 hover:from-rose-500/28 hover:to-orange-500/18'}`}>
